            ...
            <div className={styles.footerContent}>
                <section className={styles.footerSectionTop}>
                    ...
                    <div className={styles.footerLinksColumn}>
                        ...
                        <ul className={styles.footerLinkList}>
                            <li><a href="#" className={styles.footerLink}>Style Guide</a></li>
                            <li><a href="#" className={styles.footerLink}>Changelog</a></li>
                            <li><a href="#" className={styles.footerLink}>Licence</a></li>
                            <li><a href="#" className={styles.footerLink}>Webflow University</a></li>
                        </ul>
                    </div>
                    <div className={styles.footerLinksColumn}>
                ...
                <section className={styles.footerSectionBottom}>
                    ...
                    <div className={styles.footerSocials}>
                        <a href="#">
                            <img src={instagramLogo} alt="instagram" className={styles.footerSocialIcon}/>
                        </a>
                        <a href="#">
                            <img src={twitterLogo} alt="twitter" className={styles.footerSocialIcon}/>
                        </a>
                        <a href="#">
                            <img src={youtubeLogo} alt="youtube" className={styles.footerSocialIcon}/>
                        </a>
                    </div>
                </section>
            </div>
